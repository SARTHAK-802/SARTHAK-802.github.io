...
My research interest lies on DFT-based modeling of catalytic materials and the application of machine learning, including graph neural networks (GNNs), to materials discovery. I have experience in density functional theory, atomistic simulations, and materials modeling. In parallel, I have developed practical experience in machine learning (ML) and deep learning (DL), with a foundational understanding of ML interatomic potentials (MLIPs) for large-scale atomistic simulations in chemistry and materials science.
